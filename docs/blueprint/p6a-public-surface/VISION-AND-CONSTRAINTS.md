...
| P6A-D7 | **Niente double opt-in** in v1; niente IP in chiaro; rate-limit in-memory+Turnstile. | Nessun provider email attivo. Si aggiunge il double opt-in quando esisterà. |
